...
from lurk_tls13 import CSession, SSession, get_struct_index, TlsHandshake, TicketDB, SessionDB
from test_utils import *
from conf import Configuration
from cs import CryptoService
...
#  if None in session.ephemeral.private_key_list :
#    return None 
  eph = resp[ 'payload' ][ 'ephemeral_list' ][ 0 ] 
