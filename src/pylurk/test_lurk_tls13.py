...
test_struct( KeyShareClientHelloEmpty, { 'client_shares' : empty_ke_entries }  )
  ...
  for last_exchange in last_exchange_list:
    ...
    for method in eph_method_list:
      if method == 'no_secret' :
        ...
        eph = eph_e_req
      hs_list, cert_type_list = c_init_client_finished_handshake_list( ephemeral )
...
def c_init_client_hello_request_list( ):
 ...
 for handshake in c_init_client_hello_handshake_list( ):
   ...
   req_list.append( { 'session_id' : token_bytes( 4 ),
                      ...
                      'pre_share_key_len' : pre_share_key_len 
} )
   return req_list 
